...
<body> 
	<form:form action="operate.do" modelAttribute="knowledge" method="post" cssClass="layui-form layui-form-pane"> 
	 <input  type="hidden" name="id" value="${requestScope.knowledge.id}"/>
		<div class="p15">
