...
<body> 
	<form:form action="show.html?op=save" modelAttribute="sysIndustry" method="post" cssClass="layui-form layui-form-pane"> 
		<div class="p15">
			...
			<blockquote class="layui-elem-quote layui-quote-nm">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<form:checkbox path="isEnable" value="1" title="是" uncheckedValue="0" lay-skin="primary" />
					</div> 
				</div>	 
