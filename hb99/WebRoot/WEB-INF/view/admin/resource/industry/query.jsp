...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
	    <form:form action="${home}/admin/resource/industry/query.html"  modelAttribute="sysIndustry" method="get" id="frmMain">
	  	...
	  	<table class="layui-table">
			...
			<c:forEach items="${pagehelper.list}" var="row" varStatus="s"> 
				<tr>  
			    	<td>${s.index+1}</td>
			    	<td>${row.name }</td>  
			    	<td>${funcs:translate(row.isEnable, refData.isEnables)}</td>   
			    	<td>
